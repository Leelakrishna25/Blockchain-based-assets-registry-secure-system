...
main = Tk()
main.title("Blockchain Based Assets Certificate Validation")
main.geometry("1300x1200")
path = 'C:\\Users\\LEELA KRISHNA\\OneDrive\\Desktop\\major\\land1.jpg'
...
def saveCertificate():
    ...
    if len(roll_no) > 0 and len(name) > 0 and (len(contact) > 9 and len(contact)<11) and contact.isdigit()== True:
        ...
        text.insert(END," Digital Signature : "+str(digital_signature)+"\n\n")
    ...
    for i in range(len(blockchain.chain)):
        if i > 0:
            ...
            if arr[3] == digital_signature:
                ...
                text.insert(END,"Survey Number : "+arr[0]+"\n")
                text.insert(END,"Land Owner : "+arr[1]+"\n")
...
font = ('times', 15, 'bold')
title = Label(main, text='Assets Certificate Validation using Blockchain')
...
l1 = Label(main, text='SURVEY NUMBER:')
...
tf3.place(x=200,y=200)

saveButton = Button(main, text="Secure with Digital Signature", command=saveCertificate)
